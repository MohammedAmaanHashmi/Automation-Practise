...
public class LoginPageTest {
	...
	@Test(priority = 3)
	public void forgetPasswordLinkText() {
	...
	public void loginNegativeTest() {
		...
		driver.findElement(By.id("input-password")).sendKeys("pds@123");
		driver.findElement(By.xpath("//input[@value='Login']")).click();

		String errorMessage = driver.findElement(By.cssSelector("div.alert-dismissible")).toString().trim();
